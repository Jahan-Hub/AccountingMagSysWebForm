<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptSales.aspx.cs" Inherits="AccountingManagementSystem.Forms.ReportForms.rptSales" %>
        ...
        <table>
            ...
            <tr>
                ...
                <td class="auto-style1">
                    ...
                    <asp:SqlDataSource ID="dsCat" runat="server" ConnectionString="<%$ ConnectionStrings:AccountingManagementSystemConnectionString %>" SelectCommand="SELECT [Name], [CatId] FROM [tblCategory]"></asp:SqlDataSource>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="accCreditVoucher.aspx.cs" Inherits="MAANBDERP.Forms.accCreditVoucher" %>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" TabIndex="2"></DatePopupButton>
        ...
        <tr>
                <td colspan="6">
                    ...
                    <asp:Label ID="Label24" runat="server" Text="Office/Branch"></asp:Label>
                ...
                &nbsp;<asp:Label ID="Label25" runat="server" Text="Execute By"></asp:Label>
                &nbsp;<telerik:RadComboBox ID="cmSalesMan" EnableLoadOnDemand="true" Filter="Contains" Runat="server" EmptyMessage="Select Salesman" OnItemsRequested="cmSalesMan_ItemsRequested" TabIndex="12" Width="140px">
                    ...
                    <telerik:RadComboBox ID="cmCustCode" EnableLoadOnDemand="true" Filter="Contains" Runat="server" EmptyMessage="Select Customer" OnItemsRequested="cmCustCode_ItemsRequested" TabIndex="13" AutoPostBack="True" OnSelectedIndexChanged="cmCustCode_SelectedIndexChanged" Width="150px">
                    </telerik:RadComboBox>
                            </td>
                        </tr>
                        <tr>

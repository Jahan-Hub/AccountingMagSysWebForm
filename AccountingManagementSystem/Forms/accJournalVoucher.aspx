...
<body>
    <form id="form1" runat="server">
         ...
         <h1 style="background-color:coral;color:white">Journal Voucher</h1>
    <div>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" TabIndex="2"></DatePopupButton>
            ...
            <tr>
                <td colspan="6">
                    ...
                    <asp:Label ID="Label23" runat="server" Text="Credit For (Purpose)"></asp:Label>
                            </td>
                            <td class="auto-style5">
                    <asp:Label ID="Label18" runat="server" Text="Account Code"></asp:Label>
                            </td>
                            <td class="auto-style5">
                    <asp:Label ID="Label11" runat="server" Text="Cheque No"></asp:Label>
                        ...
                        <tr>
                            <td class="auto-style4">
                                <telerik:RadComboBox ID="cmCredit" EnableLoadOnDemand="true" DropDownWidth="350px" Filter="Contains" Runat="server" Width="100%" AutoPostBack="True" TabIndex="3" OnItemsRequested="cmCredit_ItemsRequested" OnSelectedIndexChanged="cmCredit_SelectedIndexChanged">
                                    <%--<HeaderTemplate>
        ...
        <tr>
                <td colspan="6">
                    <fieldset>
                       <%-- <legend>Debit To</legend>--%>
                        ...
                        <tr>
                            <td class="auto-style4">
                    <asp:Label ID="Label22" runat="server" Text="Account Name"></asp:Label>
                            </td>
                            <td class="auto-style4">
                    <asp:Label ID="Label13" runat="server" Text="Account Code"></asp:Label>
                            </td>
                            <td>
                    ...
                    <asp:Label ID="Label15" runat="server" Text="Credit Amount"></asp:Label>
                        ...
                        <tr>
                            <td class="auto-style4">
                                <telerik:RadComboBox ID="cmDebit" EnableLoadOnDemand="true" DropDownWidth="350px" Filter="Contains" Runat="server" OnItemsRequested="cmDebit_ItemsRequested" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="cmDebit_SelectedIndexChanged" TabIndex="6">
                                     <%--<HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="font-family: Arial; font-size: 10px; width: 250px;">Account Head</td>
                    ...
                    <telerik:RadTextBox ID="txtDebitCodeParticular" Runat="server" Width="80px" TabIndex="7">
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtCreditAmount" Runat="server" Width="100%" TabIndex="9" AutoPostBack="True" OnTextChanged="txtCreditAmount_TextChanged">
                                </telerik:RadNumericTextBox>
                            </td>
                        </tr>
                        <tr>
                ...
                &nbsp;<telerik:RadComboBox ID="cmProjectName" EnableLoadOnDemand="True" Filter="Contains" Runat="server" TabIndex="10" OnItemsRequested="cmProjectName_ItemsRequested" Width="140px">
                    </telerik:RadComboBox>
                    &nbsp;<asp:Label ID="Label16" runat="server" Text="Department"></asp:Label>
                &nbsp;<telerik:RadComboBox ID="cmDepartment" EnableLoadOnDemand="true" Filter="Contains" Runat="server" EmptyMessage="Select Department" OnItemsRequested="cmDepartment_ItemsRequested" TabIndex="11" Width="140px">
                    </telerik:RadComboBox>
                &nbsp;<asp:Label ID="Label25" runat="server" Text="Executive By"></asp:Label>
                &nbsp;
                    <telerik:RadComboBox ID="cmSalesMan" EnableLoadOnDemand="true" Filter="Contains" Runat="server" EmptyMessage="Select Salesman" OnItemsRequested="cmSalesMan_ItemsRequested" TabIndex="12" Width="140px">
                    </telerik:RadComboBox>
                ...
                &nbsp;
                    ...
                    <telerik:RadTextBox ID="txtNarattion" Runat="server" Width="90%" TextMode="MultiLine" TabIndex="14">
                    </telerik:RadTextBox>
                            </td>
                        </tr>
                        <tr>
...
<ModelErrorMessage Text=""></ModelErrorMessage>
                                ...
                                <telerik:GridBoundColumn DataField="post_state" FilterControlAltText="Filter post_state column" HeaderText="Status" SortExpression="post_state" UniqueName="post_state">
                                    <ColumnValidationSettings>
                                        <ModelErrorMessage Text="" />
                                    </ColumnValidationSettings>
                                </telerik:GridBoundColumn>
            ...
            <tr>
                ...
                <td>
                    &nbsp;</td>
                <td>
                                <telerik:RadNumericTextBox ID="txtTotalDebit" Runat="server" Width="100px" ReadOnly="True">
                                </telerik:RadNumericTextBox>
                </td>
                <td>
                                <telerik:RadNumericTextBox ID="txtTotalCredit" Runat="server" Width="100px" ReadOnly="True">
                                </telerik:RadNumericTextBox>
                </td>
            </tr>
            ...
            <tr>
                <td class="auto-style2" colspan="6"><telerik:RadButton ID="btnNew" runat="server" Text="New" OnClick="btnNew_Click" TabIndex="17">
                            ...
                            <telerik:RadButton ID="btnCancel" runat="server" Text="Cancel" OnClick="btnCancel_Click" TabIndex="23">
                            </telerik:RadButton>
                            <telerik:RadButton ID="btnPreview" runat="server" Text="Print Preview" OnClick="btnPreview_Click" TabIndex="24">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyInfo.aspx.cs" Inherits="AccountingManagementSystem.Forms.CompanyInfo" %>
...
<body>
    ...
    <div>
        ...
        <table class="auto-style1" style="width: 50%">
            ...
            <tr>
                <td>&nbsp;</td>
                <td><asp:FileUpload ID="FileUpload2" runat="server" onchange="previewFile()" OnDataBinding="FileUpload2_DataBinding" ValidateRequestMode="Inherit" />
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>

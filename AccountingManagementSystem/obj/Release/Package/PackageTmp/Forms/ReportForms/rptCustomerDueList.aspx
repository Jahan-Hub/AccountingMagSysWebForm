<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptCustomerDueList.aspx.cs" Inherits="SalesMS.Forms.ReportForms.rptCustomerDueList" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cmReportFormat" Runat="server" Width="300px" AutoPostBack="True" OnSelectedIndexChanged="cmReportFormat_SelectedIndexChanged">
                        <Items>
                            <telerik:RadComboBoxItem runat="server" Text="Credit Report" Value="Credit Report" />
            ...
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cmCustomer" runat="server" EnableLoadOnDemand="true" EmptyMessage="Select A Customer" Width="300px" OnItemsRequested="cmCustomer_ItemsRequested" Filter="Contains">
                    </telerik:RadComboBox>

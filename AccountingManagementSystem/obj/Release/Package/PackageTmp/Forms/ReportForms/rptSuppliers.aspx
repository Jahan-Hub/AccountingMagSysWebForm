<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptSuppliers.aspx.cs" Inherits="SalesMS.Forms.rptSuppliers" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cmReportFormat" Runat="server" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="cmReportFormat_SelectedIndexChanged">
                        <Items>
                            <telerik:RadComboBoxItem runat="server" Text="Supplier(Excel Aid)" Value="Supplier(Excel Aid)" />
            ...
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cmCommon" Runat="server" Filter="Contains" EnableLoadOnDemand="true" EmptyMessage="Select A Supplier" OnItemsRequested="cmCommon_ItemsRequested" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="cmCommon_SelectedIndexChanged" Enabled="False">
                    </telerik:RadComboBox>
                </td>
            </tr>
            <tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockAdjustments.aspx.cs" Inherits="SalesMS.Forms.StockAdjustments" %>
        ...
        <telerik:RadGrid ID="rgMain" runat="server" AllowPaging="True" AllowMultiRowSelection="True" AutoGenerateColumns="False" OnSelectedIndexChanged="rgMain_SelectedIndexChanged" OnNeedDataSource="rgMain_NeedDataSource">
            ...
            <MasterTableView>
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="AdjDate" FilterControlAltText="Filter TransactionDate column" HeaderText="Adjustment Date" SortExpression="AdjDate" UniqueName="AdjDate" DataFormatString="{0:d}" DataType="System.DateTime">
                        <ColumnValidationSettings>
                            <ModelErrorMessage Text="" />
                        </ColumnValidationSettings>
                    </telerik:GridBoundColumn>

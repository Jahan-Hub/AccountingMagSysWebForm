<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpeningStock.aspx.cs" Inherits="SalesMS.Forms.OpeningStock" %>
        ...
        <telerik:RadGrid ID="rgMain" runat="server" AllowPaging="True" AllowMultiRowSelection="True" AutoGenerateColumns="False" OnSelectedIndexChanged="rgMain_SelectedIndexChanged" OnNeedDataSource="rgMain_NeedDataSource">
            ...
            <MasterTableView>
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="EntryDate" FilterControlAltText="Filter TransactionDate column" HeaderText="Entry Date" SortExpression="EntryDate" UniqueName="EntryDate" DataFormatString="{0:d}" DataType="System.DateTime">
                        <ColumnValidationSettings>
                            <ModelErrorMessage Text="" />
                        </ColumnValidationSettings>
                    </telerik:GridBoundColumn>

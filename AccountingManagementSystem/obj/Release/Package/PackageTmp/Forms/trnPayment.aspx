<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="trnPayment.aspx.cs" Inherits="SalesMS.Forms.trnPayment" %>
        ...
        <div>
            <table style="width: 100%">
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="cmPartyName" runat="server" Width="100%" EnableLoadOnDemand="true" EmptyMessage="Select Supplier" OnItemsRequested="cmPartyName_ItemsRequested" AutoPostBack="True" Filter="Contains" DropDownAutoWidth="Enabled" Height="400px">
                            <HeaderTemplate>
                    ...
                    <td>
                        <telerik:RadComboBox ID="cmBillNo" Filter="Contains" runat="server" AutoPostBack="True" EnableLoadOnDemand="true" EmptyMessage="Select Bill No" OnItemsRequested="cmBillNo_ItemsRequested" OnSelectedIndexChanged="cmBillNo_SelectedIndexChanged">
                        </telerik:RadComboBox>
                    </td>
                    <td>&nbsp;</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="cmPayMode" Filter="Contains" runat="server" AutoPostBack="True" EmptyMessage="Select Pay Mode" OnSelectedIndexChanged="cmPayMode_SelectedIndexChanged">
                            <Items>
                            ...
                            <telerik:RadGrid ID="RadGrid1" Width="100%" runat="server" AutoGenerateColumns="False" OnNeedDataSource="RadGrid1_NeedDataSource" ShowFooter="True">
                                ...
                                <MasterTableView>
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="PayDate" FilterControlAltText="Filter PayDate column" HeaderText="Pay Date" SortExpression="PayDate" UniqueName="PayDate" DataType="System.DateTime" DataFormatString="{0:d}">
                                            <ColumnValidationSettings>
                                                <ModelErrorMessage Text="" />
                                            </ColumnValidationSettings>
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridBoundColumn DataField="ChequeDate" FilterControlAltText="Filter ChequeDate column" HeaderText="Cheque Date" SortExpression="ChequeDate" UniqueName="ChequeDate" DataType="System.DateTime" DataFormatString="{0:d}">
                                            <ColumnValidationSettings>
                                                <ModelErrorMessage Text="" />
                                            </ColumnValidationSettings>
                                        </telerik:GridBoundColumn>
